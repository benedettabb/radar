var region = ee.FeatureCollection("users/bene96detta/shp_file/umbria_marche")
var point = ee.Geometry.Point([12.622604781978932, 43.13854376175809]);
Map.addLayer(region,{color: '08ffcc'},'Marche e Umbria')
...
var values = img.sample({region: region, scale: 500, numPixels:2000, geometries: true}) 
...
var values2 = img2.sample({region: region, scale: 500, numPixels:2000, geometries: true}) 
