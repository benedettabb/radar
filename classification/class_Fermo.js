...
//combine GRD SLC e Sentienel2 //shape file of Fermo
var tot201509 = ee.Image.cat ([asc201509, asc201509dec, s2201509]).clip(fermo)
var tot201512 = ee.Image.cat ([asc201512, asc201512dec, s2201512]).clip(fermo)
var tot201609 = ee.Image.cat ([asc201609, asc201609dec, s2201609]).clip(fermo)
var tot201612 = ee.Image.cat ([asc201612, asc201612dec, s2201612]).clip(fermo)
var tot201708 = ee.Image.cat ([asc201708, asc201708dec, s2201709]).clip(fermo)
var tot201712 = ee.Image.cat ([asc201712, asc201712dec, s2201712]).clip(fermo)
var tot201809 = ee.Image.cat ([asc201809, asc201809dec, s2201809]).clip(fermo)
var tot201812 = ee.Image.cat ([asc201812, asc201812dec, s2201812]).clip(fermo)
var tot201909 = ee.Image.cat ([asc201909, asc201909dec, s2201909]).clip(fermo)
var tot201912 = ee.Image.cat ([asc202001, asc202001dec, s2201912]).clip(fermo)
var tot202009 = ee.Image.cat ([asc202009, asc202009dec, s2202009]).clip(fermo)
var tot202012 = ee.Image.cat ([asc202012, asc202012dec, s2202012]).clip(fermo)
...
var bands = ['VV','VH','B2','B3','B8','B4','B5','B6','NDVI','B11','B12','NDBI','Entropy','Alpha','span','ratio']
...
var train = train201509.merge(train201512)
...
var desc201608 = norm.normDESC(toDB.toDB(desc201608))
var desc201612 = norm.normDESC(toDB.toDB(desc201612))
var desc201709 = norm.normDESC(toDB.toDB(desc201709))
...
var tot201509desc = ee.Image.cat ([desc201509, desc201509dec, s2201509]).clip(fermo)
var tot201512desc = ee.Image.cat ([desc201512, desc201512dec, s2201512]).clip(fermo)
var tot201609desc = ee.Image.cat ([desc201608, desc201608dec, s2201609]).clip(fermo)
var tot201612desc = ee.Image.cat ([desc201612, desc201612dec, s2201612]).clip(fermo)
var tot201708desc = ee.Image.cat ([desc201709, desc201709dec, s2201709]).clip(fermo)
var tot201712desc = ee.Image.cat ([desc201712, desc201712dec, s2201712]).clip(fermo)
var tot201809desc = ee.Image.cat ([desc201809, desc201809dec, s2201809]).clip(fermo)
var tot201812desc = ee.Image.cat ([desc201812, desc201812dec, s2201812]).clip(fermo)
var tot201909desc = ee.Image.cat ([desc201909, desc201909dec, s2201909]).clip(fermo)
var tot201912desc = ee.Image.cat ([desc202001, desc202001dec, s2201912]).clip(fermo)
var tot202009desc = ee.Image.cat ([desc202009, desc202009dec, s2202009]).clip(fermo)
var tot202012desc = ee.Image.cat ([desc202012, desc202012dec, s2202012]).clip(fermo)
