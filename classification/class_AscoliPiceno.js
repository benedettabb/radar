...
var tot201612 = ee.Image.cat ([asc201612, asc201612dec, s2201612]).clip(ap)
var tot201708 = ee.Image.cat ([asc201708, asc201708dec, s2201709]).clip(ap)
var tot201712 = ee.Image.cat ([asc201712, asc201712dec, s2201712]).clip(ap)
var tot201809 = ee.Image.cat ([asc201809, asc201809dec, s2201809]).clip(ap)
var tot201812 = ee.Image.cat ([asc201812, asc201812dec, s2201812]).clip(ap)
var tot201909 = ee.Image.cat ([asc201909, asc201909dec, s2201909]).clip(ap)
var tot201912 = ee.Image.cat ([asc202001, asc202001dec, s2201912]).clip(ap)
var tot202009 = ee.Image.cat ([asc202009, asc202009dec, s2202009]).clip(ap)
var tot202012 = ee.Image.cat ([asc202012, asc202012dec, s2202012]).clip(ap)
...
var bands = ['B2','B3','B8','B4','B5','B6','NDVI','B11','B12','NDBI','VV','VH','Entropy','Alpha','span','ratio']
...
var train201612 = tot201612.select(bands).sampleRegions ({
  ...
  scale: 200,
  tileScale: 16})
var train201708 = tot201708.select(bands).sampleRegions ({
  collection: newfc201708,
  properties: ['landcover'],
  scale: 200,
  tileScale: 16})
...
var train = train201512.merge(train201509)
          .merge(train201609).merge(train201612)
          .merge(train201708).merge(train201712)
          .merge(train201809).merge(train201812)
          .merge(train201909).merge(train201912)
          .merge(train202009).merge(train202012)
...
var params = {min:0,max:6, palette: ['256706','orange','blue','green','white','brown','pink']}

Map.addLayer(ee.Image(asc_class.toList(13).get(0)),params, '201509',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(1)),params, '201512',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(2)),params, '201609',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(3)),params, '201612',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(4)),params, '201709',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(5)),params, '201712',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(6)),params, '201809',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(7)),params, '201812',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(8)),params, '201909',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(9)),params, '202002',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(10)),params, '202009',0)
Map.addLayer(ee.Image(asc_class.toList(13).get(11)),params, '202012',0)
...
var tot201509desc = ee.Image.cat ([desc201509, desc201509dec, s2201509]).clip(ap)
var tot201512desc = ee.Image.cat ([desc201512, desc201512dec, s2201512]).clip(ap)
var tot201609desc = ee.Image.cat ([desc201609, desc201609dec, s2201609]).clip(ap)
var tot201612desc = ee.Image.cat ([desc201612, desc201612dec, s2201612]).clip(ap)
var tot201708desc = ee.Image.cat ([desc201708, desc201708dec, s2201709]).clip(ap)
var tot201712desc = ee.Image.cat ([desc201712, desc201712dec, s2201712]).clip(ap)
var tot201809desc = ee.Image.cat ([desc201809, desc201809dec, s2201809]).clip(ap)
var tot201812desc = ee.Image.cat ([desc201812, desc201812dec, s2201812]).clip(ap)
var tot201909desc = ee.Image.cat ([desc201909, desc201909dec, s2201909]).clip(ap)
var tot201912desc = ee.Image.cat ([desc202001, desc202001dec, s2201912]).clip(ap)
var tot202009desc = ee.Image.cat ([desc202009, desc202009dec, s2202009]).clip(ap)
var tot202012desc = ee.Image.cat ([desc202012, desc202012dec, s2202012]).clip(ap)
